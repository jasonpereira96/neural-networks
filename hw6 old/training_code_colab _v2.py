...
MODEL_FILENAME = "model/model_weights.pth" if is_dataset_local() else 'drive/MyDrive/NN/hw6/model/model_weights_v2_2021-11-01 08:42:55.pth'
SAVE_MODEL = True
LOAD_WEIGHTS = False
BATCH_SIZE = 1
...
class ImageDataset(Dataset):
  ...
  def __getitem__(self, index):
    ...
    # print(img_path)
      if self.mode == "test":
        img_path = 'hw6/geometry_dataset/test/' + self.img_labels[index]  
      else:
      ...
      image_file = self.zip_file.open('hw6/geometry_dataset/test/Triangle_ffa8bf6c-2a83-11ea-8123-8363a7ec19e6_bw.png')
  ...
  def test():
    ...
    for i, data in enumerate(test_dataloader, 0):
        ...
        for index in range(1):
          expected_output = get_label_from_index(labels[index])
  ...
  def train():
    ...
    for epoch in range(25):  # loop over the dataset multiple times
      ...
      if SAVE_MODEL:
        ...
        model_filename = 'drive/MyDrive/NN/hw6/model/model_weights_v3_' + get_current_timestamp() + '.pth'
        torch.save(network.state_dict(), model_filename)
        print("Model saved to {}".format(model_filename))
